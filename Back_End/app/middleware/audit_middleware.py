...
class AuditLoggingMiddleware(BaseHTTPMiddleware):
    ...
    async def _extract_request_body(self, request: Request) -> dict:
        ...
        # TEMPORARY FIX: Disable body reading to prevent RuntimeError with BaseHTTPMiddleware
        # The error "Unexpected message received: http.request" occurs when consuming 
        # the stream in middleware.
        return {}
